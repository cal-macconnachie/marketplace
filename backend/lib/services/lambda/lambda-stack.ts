...
export class LambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: LambdaConstructProps) {
    super(scope, id)
    const {
      envVars, envName, userPool, hostedZones
    } = props
    ...
    if (hostedZones) {
      ...
      if (hostedZone) {
        ...
        const certificate = new cdk.aws_certificatemanager.Certificate(this, `ApiCertificate-${envName}`, {
        ...
        new cdk.aws_route53.ARecord(this, `ApiARecord-${envName}`, {
          zone: hostedZone,
