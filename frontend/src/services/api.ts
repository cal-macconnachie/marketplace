...
const BASE_URL = import.meta.env.VITE_API_ENV === 'dev' ? `https://${import.meta.env.VITE_API_ENV}.api.marketplace.csm.codes/${import.meta.env.VITE_API_ENV}` : `https://api.marketplace.csm.codes/${import.meta.env.VITE_API_ENV}`
const IMAGE_URL = import.meta.env.VITE_API_ENV === 'dev' ? `https://${import.meta.env.VITE_API_ENV}.images.marketplace.csm.codes` : 'https://images.marketplace.csm.codes'
...
export interface Product {
  ...
  default_price_data: {
    ...
    unit_label?: string // Unit label for metered products (e.g., "MB", "100 Tokens", "image")
...
export interface Organization {
  ...
  // stripe fields
  stripe_subscription_ids?: Record<string, string> // Map of account IDs to subscription IDs
